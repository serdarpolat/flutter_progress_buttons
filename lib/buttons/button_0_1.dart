...
class Button01 extends StatefulWidget {
  @override
  Button01State createState() {
    return new Button01State();
  }
}

class Button01State extends State<Button01> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    anim = Tween<double>(begin: 0.0, end: 0.77).animate(CurvedAnimation(
      parent: ctrl,
